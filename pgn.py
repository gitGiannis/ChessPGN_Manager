...
class FilePGN:
    ...
    def __init__(self, file_path: str):
        ...
        self.game_data = self.split_files()
    ...
    def get_index_of_games(self) -> list:
        """
        ...
        for num in range(len(self.game_data)):
            if num % 2 == 0:
