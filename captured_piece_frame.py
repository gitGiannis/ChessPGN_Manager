...
class CapturedPieceFrame(Frame):
    ...
    Μέθοδοι:
    --------
        update_frame(self) -> str:
            ενημερώνει το ταμπλό αιχμαλωτισμένων κομματιών, επιστρέφει συμβ/ρα με το tag του κομματιού
    ...
    def next_round(self):
        ...
        current_piece_tag = self.update_frame()
